...
| --- | --- | --- |
| 🍎 **macOS** (Intel or Apple Silicon) | [**VetCPA-0.1.4.dmg**](https://github.com/ANI-ML/VetCPA/releases/download/v0.1.4/VetCPA-0.1.4.dmg) | ~348 MB |
| 🪟 **Windows 10 / 11** (64-bit) | [**VetCPA-windows-0.1.4.zip**](https://github.com/ANI-ML/VetCPA/releases/download/v0.1.4/VetCPA-windows-0.1.4.zip) | ~315 MB |
...
./scripts/make_dmg.sh               # wraps it as dist/VetCPA-0.1.4.dmg
```
